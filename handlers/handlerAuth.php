...
if (!empty($_POST['login']) and !empty($_POST['password']) and !empty($_POST['password_second'])) {
    if ($_POST['password'] == $_POST['password_second']) {
        echo 'Пароль и его подтверждение совпадают';
    } else {
        echo 'Пароль и его подтверждение не совпадают. Попробуйте ввести данные еще раз';
    }
}
